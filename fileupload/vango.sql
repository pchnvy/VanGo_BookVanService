...
-- ----------------------------
INSERT INTO `tbl_m_employee` VALUES ('E1234', 'Patiphan', 'Patdam', '58160083@go.buu.ac.th', '12345', 'ชาย', '0623870310', '2020-06-10', b'0');
...
-- ----------------------------
INSERT INTO `tbl_m_route` VALUES ('R01', 'บางแสน-กรุงเทพ', 'บางแสน', 'กรุงเทพฯ', 120, 140.00, '1 2 3 4 5', '2020-06-03 13:27:47', 'E1234', '2020-06-03 13:27:47', 'E1234');
...
-- ----------------------------
INSERT INTO `tbl_m_seat` VALUES ('VAN001', 'S01', 'Seat 01');
INSERT INTO `tbl_m_seat` VALUES ('VAN001', 'S02', 'Seat 02');
INSERT INTO `tbl_m_seat` VALUES ('VAN001', 'S03', 'Seat 03');
INSERT INTO `tbl_m_seat` VALUES ('VAN001', 'S04', 'Seat 04');
INSERT INTO `tbl_m_seat` VALUES ('VAN001', 'S05', 'Seat 05');
INSERT INTO `tbl_m_seat` VALUES ('VAN001', 'S06', 'Seat 06');
INSERT INTO `tbl_m_seat` VALUES ('VAN001', 'S07', 'Seat 07');
INSERT INTO `tbl_m_seat` VALUES ('VAN001', 'S08', 'Seat 08');
INSERT INTO `tbl_m_seat` VALUES ('VAN001', 'S09', 'Seat 09');
INSERT INTO `tbl_m_seat` VALUES ('VAN001', 'S10', 'Seat 10');
INSERT INTO `tbl_m_seat` VALUES ('VAN001', 'S11', 'Seat 11');
INSERT INTO `tbl_m_seat` VALUES ('VAN001', 'S12', 'Seat 12');
INSERT INTO `tbl_m_seat` VALUES ('VAN001', 'S13', 'Seat 13');
INSERT INTO `tbl_m_seat` VALUES ('VAN001', 'S14', 'Seat 14');
...
CREATE TABLE `tbl_m_user`  (
  ...
  `Email` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Password` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `PaymentNumber` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `PaymentMethod` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Sex` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Telephone` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `FlagDelete` bit(1) NOT NULL,
...
-- ----------------------------
INSERT INTO `tbl_m_user` VALUES ('USER000001', 'Patiphan', 'Patdam', 'iitodoii10@gmail.com', '12345', '123123123', 'PayPal', 'ชาย', '0614986891', b'0');
...
-- ----------------------------
INSERT INTO `tbl_m_van` VALUES ('VAN001', 'กข 101', 'LPG', '2020-06-03 13:26:53', 'E1234', '2020-06-03 13:26:53', 'E1234');
...
-- ----------------------------
INSERT INTO `tbl_t_round` VALUES ('20200603-001', '13:30:00', 'R01', 'VAN001', 'E1234', '2020-06-03 13:28:12', 'E1234', '2020-06-03 13:28:12', 'E1234');
INSERT INTO `tbl_t_round` VALUES ('20200603-002', '18:00:00', 'R01', 'VAN001', 'E1234', '2020-06-03 13:50:01', 'E1234', '2020-06-03 13:50:01', 'E1234');
INSERT INTO `tbl_t_round` VALUES ('20200603-003', '11:00:00', 'R01', 'VAN001', 'E1234', '2020-06-03 14:17:56', 'E1234', '2020-06-03 14:17:56', 'E1234');
...
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Booking_BookVan`(IN `pRoundID` VARCHAR(30), IN `pSeatID` VARCHAR(30), IN `pUserID` VARCHAR(30), OUT `ErrorMsg` VARCHAR(255))
proc_booking:BEGIN
...
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Booking_GetHeader`(IN `pRoundID` VARCHAR(30))
BEGIN
...
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Booking_GetSeatDetail`(IN `pRoundID` VARCHAR(30))
BEGIN
...
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Booking_GetUserRound`()
BEGIN
...
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_HistoryAdmin`()
BEGIN
	
	SELECT DATE_FORMAT(NOW(), "%d %b %Y")	AS RoundDate
		, rd.RoundID
		...
		, CASE WHEN DATE_ADD(rd.RoundTime, INTERVAL rt.UsageTime MINUTE) <= NOW() THEN 2
				WHEN DATE_ADD(rd.RoundTime, INTERVAL rt.UsageTime MINUTE) > NOW() AND rd.RoundTime <= NOW() THEN 1
				ELSE 0 END	AS RoundStatus
		, CASE WHEN DATE_ADD(rd.RoundTime, INTERVAL rt.UsageTime MINUTE) <= NOW() THEN 'ได้ถึงจุดหมายเรียบร้อยแล้ว'
				WHEN DATE_ADD(rd.RoundTime, INTERVAL rt.UsageTime MINUTE) > NOW() AND rd.RoundTime <= NOW() THEN 'กำลังอยู่ระหว่างการเดินทาง'
	...
	WHERE CONVERT(rd.RoundTime, DATE) <= CONVERT(NOW(), DATE)
		AND DATE_ADD(NOW(),INTERVAL -1 MONTH) <= CONVERT(rd.RoundTime, DATE)
	GROUP BY rd.RoundTime
		, rd.RouteID
		, rt.UsageTime
		, rt.Begin
		, rt.Destination
	...
	ORDER BY rd.RoundTime DESC, rd.RouteID
	;	
...
BEGIN
	...
	ORDER BY rd.RoundTime,rd.RouteID
	;
